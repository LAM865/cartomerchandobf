...
var style_NbmerchandsiteOBF_4 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("Nb merchand");
    ...
    if (value >= 1.000000 && value <= 100.000000) {
        ...
        image: new ol.style.Circle({radius: 3.2 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,255,255,0.7)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(169,72,34,0.7)'})}),
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.8 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,255,255,0.7)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(169,72,34,0.7)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
