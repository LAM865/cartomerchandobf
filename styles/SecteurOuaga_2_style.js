...
var style_SecteurOuaga_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_SecteurOuaga_2_eval_expression(context) !== null) {
        labelText = String(exp_label_SecteurOuaga_2_eval_expression(context));
    }
